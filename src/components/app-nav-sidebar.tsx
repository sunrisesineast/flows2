...
type PrimaryNavView = "dashboard" | "reservations" | "calendar" | "cleaning" | "reports" | "finance" | "sync" | "property-settings";
...
const NAV_ITEMS: { key: PrimaryNavView; icon: ReactNode }[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5m-9-6h.008v.008H12V12.75zm-3 0h.008v.008H9V12.75zm-3 0h.008v.008H6V12.75zm9 3h.008v.008H12V15.75zm-3 0h.008v.008H9V15.75zm-3 0h.008v.008H6V15.75z" />
      </svg>
    ),
  },
  {
...
export function AppNavSidebar({
  ...
  const primaryViews: PrimaryNavView[] = ["dashboard", "reservations", "calendar", "cleaning", "reports", "finance", "sync", "property-settings"];
